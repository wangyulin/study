...
public class DotExposure {

	public static String ip = "wangyulin-test-host";
	public static String hdfsUri = String.format("hdfs://%s:9000", ip);
	public static String inputPath = String.format("hdfs://%s:9000%s", ip, "/test/hadoop/data/exposure_data");
	public static String outputPath = String.format("hdfs://%s:9000%s", ip, "/test/hadoop/data/exposure_data_output");
...
//			}
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(DotExposure.class);
