...
public class TransactionManagerMain_3 {

	static Logger log = Logger.getLogger(TransactionManagerMain_3.class);  
	
	private static final int id = 12;
	
	public static void main(String[] args) {
		ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext(
				"file:///Users/wangyulin/workDir/miui/study/datasourceTM/src/main/resources/applicationContext_3.xml");
